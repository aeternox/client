function main()
	for ItemID,DESC in pairs(tbl) do
		...
		if DispayOrigin == 2 or DisplayItemID == 1 then
			...
			AddItemIdentifiedDesc(ItemID, "^FFFFFF_^000000")
		end
		...
		if DispayOrigin == 3 or DisplayItemID == 2 or DisplayDatabase == true then
			...
			if DisplayDatabase == true then
				AddItemIdentifiedDesc(ItemID, "<URL>Database Link<INFO>https://www.divine-pride.net/database/item/"..ItemID.."</INFO></URL>")
			end
		end
	end
	return true, "good"
